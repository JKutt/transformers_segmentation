...
```{figure} ./figures/12-diffusion_network_generated_stdnorm.png
:height: 450px
:width: 350px
:name: ddpm-generated
:alt: diffusion network generated images
:align: center


Geologic models generated by Diffusion network.
```
...
$$
\frac{\partial d_{pred}}{\partial m} = \frac{\partial F(\exp(m))}{\partial \exp(m)} \frac{\partial \exp(m)}{\partial m}
$$

$$
\frac{\partial d_{pred}}{\partial m} = exp(m) * J^T
$$


```{figure} ./figures/15-data_informed_generating_model.png
:height: 650px
:width: 350px
:name: ddpm-regularization
:alt: diffusion network regularaisation
:align: center


Diffusion network as regularisation.
```
